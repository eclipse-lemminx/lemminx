...
public class DOMParser {
	...
	public DOMDocument parse(CharSequence text, String uri, URIResolverExtensionManager resolverExtensionManager) {
		return parse(new TextDocument(text.toString(), uri), resolverExtensionManager);
	}

	public DOMDocument parse(CharSequence text, String uri, URIResolverExtensionManager resolverExtensionManager,
			boolean ignoreWhitespaceContent) {
		return parse(new TextDocument(text.toString(), uri), resolverExtensionManager, ignoreWhitespaceContent);
	}
	...
	public DOMDocument parse(TextDocument document, URIResolverExtensionManager resolverExtensionManager,
		...
		while (token != TokenType.EOS) {
			...
			case EndTag:
				// end tag (ex: </root>)
				CharSequence closeTag = scanner.getTokenText();
